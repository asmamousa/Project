...
if(isset($_GET['show']))
{
    ...
    <div class="first_letter ">
        <strong>The mobile-phone or password is invalid</strong>
    </div>
    <?php
}
?>
...
if(isset($_GET['yes']))
{
    ...
    <div class="second_letter ">
        <strong>This account doesn't exist, please sign up first</strong>
    </div>
    <?php
}
?>
    ...
    <div class="form">
        <div class="thumbnail">
            ...
            <form name="form" class="login-form" method="post"  action="loginsession.php" id="log" >
                ...
                <div class="buttoninput"> <input type="text" placeholder="mobile phone(9 digits)" name="mob" id="mob" pattern="[0-9]{9}"/></div>
