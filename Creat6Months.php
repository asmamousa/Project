...
if(isset($_GET['succ6']))
{
    ?>
    <div class="third">
        <p class="message"> You're almost done, Please <a href="pay6.php">Pay</a></p>
    </div>
    <?php
}
?>
...
<div class="container container2" style="height: 500px ; width : 950px;background-color: white ">
    ...
    <div class="form ">
        ...
        <form  class="login-form" method="post" action="register6mon.php" id="re">
            &emsp; &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;

            <div class="buttoninput"> <input type="text" placeholder="mobile phone(9 digits)" name="mob6" id="mob6" pattern="[0-9]{3}[0-9]{6}" /> </div>
            &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;

            <div class="buttoninput"> <input type="password" placeholder="password" id="pass6" name="pass6"/> </div>
            &emsp; &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
            <div class="buttoninput">  <input type="text" placeholder="First Name(10 characters)" id="name6" name="name6" pattern="[A-z]{1,10}"/></div>
            &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;

            <div class="buttoninput"> <input type="text" placeholder="Age (18-40)" id="age6" name="age6"/> </div>
            <br>
            &emsp; &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
            <div class="buttoninput"> <input type="text" placeholder="Height (140-190)" id="h6" name="h6" pattern="[1]{1}[4-8]{1}[0-9]{1}"/></div>
            &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
            <div class="buttoninput"> <input type="text" placeholder="Weight (60-90)" id="w6" name="w6" pattern="[6-8]{1}[0-9]{1}"/></div>
