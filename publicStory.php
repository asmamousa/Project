                        ...
                        <article class="recipe" style="background-color: white; opacity: .9">
                            ...
                            <div class="recipe-detail">
                                ...
                                <p><br><br><br>
                                    ...
                                    $query4445=" SELECT Story FROM ourstories";
                                    $result41=mysqli_query($db,$query4445) or die("error");
                                    while($row = mysqli_fetch_assoc($result41)) {
                                        $ss = $row['Story'];
                                    }
                                    if(empty($ss)){
                                        echo "I started using this website two months ago and i've already lost nine kilos.
                                        It's great how it keeps track my daily diet system
                                         <br>  christina (june 2016)";
                                    }
