            ...
            <main class="main-content">
                ...
                <div class="content">
                    ...
                    <div class="contact-form" >
                        <div class="row" >
                            <div class="col-md-5">
                                <form method="post" action="regFree.php">

                                    <input type="text" style="background-color: black; opacity: .1; color: white;" placeholder="credit card SIN" id="SINF" name="SINF">
                                    <input type="password" style="background-color: black; opacity: .1; color: white;" placeholder="Password..." id="CPF" name="CPF">
                                    <input type="text" style="background-color: black; opacity: .1; color: white;" placeholder="User BankName..." name="BNF" id="BNF">
                                    <input type="text" style="background-color: black; opacity: .1; color: white;" placeholder="Duration of Diet Program" name="DF" id="DF">
